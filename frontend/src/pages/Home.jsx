...
/* ─────────────────────────────────────────────────────────────────
   COLOR TOKENS  — Janaya360 Parliament Color System
   Primary   : parliament-600  #EA580C  (orange)
   Hover     : parliament-700  #C2410C
   Light bg  : parliament-50   #FFF7ED
...
const HERO_SLIDES = [
  {
    ...
    src: '/lotes.jpg',
    fb: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5b/Sri_Lanka_Parliament_2.jpg/1280px-Sri_Lanka_Parliament_2.jpg',
  },
  {
    name: 'Supreme Court of Sri Lanka',
    region: 'Colombo 12',
    src: '/cort.jpg',
    fb: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/54/Supreme_Court_of_Sri_Lanka.jpg/1280px-Supreme_Court_of_Sri_Lanka.jpg',
  },
  {
    name: 'Presidential Secretariat',
    region: 'Colombo Fort',
    src: '/h1.jpg',
    fb: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6e/Presidential_Secretariat%2C_Colombo.jpg/1280px-Presidential_Secretariat%2C_Colombo.jpg',
  },
];
...
const POLITICIANS = [
  ...
  },
  {
    ...
    rating: 70.8,
    trend: '+2.1%',
    color: '#EA580C',           // UNP — parliament orange
    partyBg: '#FFF7ED',
    partyText: '#9A3412',
...
const FEATURES = [
  { icon:ShieldCheckIcon,         title:'Promise Tracking',      desc:'Track political promises with status updates, supporting evidence, and public accountability.', gradient:'from-orange-600 to-orange-500',  stat:'95% Accuracy', delay:0   },
  { icon:ChartBarIcon,            title:'Performance Analytics', desc:'View completion rates, politician ratings, and promise fulfillment history.',                   gradient:'from-orange-600 to-amber-500',   stat:'Live Updates',  delay:0.1 },
  { icon:GlobeAltIcon,            title:'News Integration',      desc:'Connect political news and developments with ongoing promises and public feedback.',             gradient:'from-orange-600 to-orange-500',  stat:'24/7 Updates',  delay:0.2 },
  { icon:ChatBubbleLeftRightIcon, title:'Citizen Feedback',      desc:'Let citizens contribute reports, opinions, and evidence for better transparency.',              gradient:'from-orange-700 to-orange-500',  stat:'10k+ Reviews',  delay:0.3 },
];
...
const HeroSlideshow = () => {
  ...
  return (
    <div className="absolute inset-0 z-0">
      ...
      {/* overlays */}
      <div className="absolute inset-0 bg-gradient-to-b from-black/72 via-black/52 to-orange-950/88 z-10" />
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center gap-3">
        <AnimatePresence mode="wait">
          ...
          >
            <MapPinIcon className="w-4 h-4 text-orange-300 flex-shrink-0" />
          ...
          {HERO_SLIDES.map((_, i) => (
            <button
              ...
              style={{
                ...
                background: i === cur ? '#EA580C' : 'rgba(255,255,255,0.32)',
...
const LandmarkStrip = () => {
  ...
  return (
    <div className="relative overflow-hidden bg-orange-950 py-1">
      <motion.div
        ...
        {doubled.map((item, i) => (
          <div key={i} className="relative flex-shrink-0 overflow-hidden" style={{ width: 240, height: 140, margin: '0 3px' }}>
            ...
            <div className="absolute bottom-2.5 left-3 flex items-center gap-1.5">
              <MapPinIcon className="w-3 h-3 text-orange-300 flex-shrink-0" />
    ...
    <div ref={ref} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      {STATS.map((s, i) => (
        <motion.div
          ...
          className="bg-white/96 dark:bg-gray-800/96 backdrop-blur-sm rounded-2xl shadow-xl p-6 border border-orange-100 dark:border-gray-700 hover:shadow-2xl transition-all"
        >
    ...
    <div className="overflow-hidden">
        ...
        <div className="relative z-20 container mx-auto px-4 py-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <motion.div initial={{ opacity:0, y:20 }} animate={{ opacity:1, y:0 }} transition={{ duration:0.8 }} className="mb-6">
              <span className="inline-flex items-center px-5 py-2.5 rounded-full bg-white/12 backdrop-blur-md text-orange-200 text-sm font-semibold border border-white/22">
            ...
            <motion.div initial={{ opacity:0, y:20 }} animate={{ opacity:1, y:0 }} transition={{ duration:0.8, delay:0.6 }} className="flex flex-col sm:flex-row gap-4 justify-center">
              {/* primary CTA — parliament orange */}
              <Link
                to="/politicians"
                className="group inline-flex items-center justify-center px-8 py-4 bg-orange-600 text-white rounded-xl font-semibold hover:bg-orange-700 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-orange-500/30"
              >
                Start Tracking Now
            ...
            <motion.div initial={{ opacity:0 }} animate={{ opacity:1 }} transition={{ delay:1 }} className="mt-12 flex flex-wrap justify-center gap-6">
              {['Trusted by citizens','Visual promise tracking','Sri Lanka focused'].map((b, i) => (
                <div key={i} className="flex items-center gap-2 text-sm text-white/70">
                  <CheckBadgeIcon className="w-4 h-4 text-orange-400" />{b}
                </div>
              ))}
            </motion.div>
          </div>
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <motion.div initial={{ opacity:0, y:20 }} whileInView={{ opacity:1, y:0 }} transition={{ duration:0.6 }} className="text-center mb-16">
            {/* orange badge */}
            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange-100 dark:bg-orange-500/20 text-orange-700 dark:text-orange-400 text-sm font-semibold mb-6">
              <MapPinIcon className="w-4 h-4" /> Built for Sri Lanka
            </span>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-4">
              Powerful Features for
              {/* orange gradient */}
              <span className="bg-gradient-to-r from-orange-600 to-amber-500 bg-clip-text text-transparent"> Democratic Transparency</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {FEATURES.map((f, i) => (
              <motion.div
                ...
                transition={{ delay:f.delay }} whileHover={{ y:-10 }}
                onHoverStart={() => setHoveredCard(i)} onHoverEnd={() => setHoveredCard(null)}
                className="group relative"
              >
                {/* orange hover glow */}
                <div className="absolute inset-0 bg-gradient-to-r from-orange-500 to-amber-500 rounded-2xl opacity-0 group-hover:opacity-10 transition-opacity duration-300" />
                <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 h-full hover:shadow-2xl transition-all border border-gray-100 dark:border-gray-700">
                  ...
                  <div className="flex items-center justify-between">
                    {/* orange stat label */}
                    <span className="text-sm font-semibold text-orange-600">{f.stat}</span>
                    <ChevronRightIcon className="w-5 h-5 text-gray-400 group-hover:text-orange-600 group-hover:translate-x-1 transition-all" />
                  </div>
                </div>
              </motion.div>
            ))}
        ...
        <div className="container mx-auto px-4 relative z-10">
          <motion.div initial={{ opacity:0, y:20 }} whileInView={{ opacity:1, y:0 }} className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-4">
              ...
              <span className="block text-orange-600">Performance Dashboard</span>
            </h2>
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Real-time tracking — President AKD, Sajith Premadasa & Ranil Wickremesinghe
            </p>
          </motion.div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden border border-gray-100 dark:border-gray-700">
                  ...
                  <div className="relative overflow-hidden bg-gray-200 dark:bg-gray-700" style={{ height: 300 }}>
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-6">
                      ...
                      <p className="text-white/75 text-xs leading-snug">{p.role}</p>
                    </div>
                    {/* party badge — each party's own color */}
                    <div className="absolute top-4 right-4">
                      <span
                        className="px-3 py-1.5 rounded-full text-sm font-bold shadow"
                        style={{ background: p.partyBg, color: p.partyText }}
                      >
                        {p.party}
                      </span>
                    </div>
                  ...
                  <div className="p-6">
                    ...
                    {/* progress bar in each politician's party color */}
                    ...
                    <Link
                      ...
                      className="block w-full text-center py-3 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-xl hover:bg-orange-600 hover:text-white transition-all font-semibold"
                    >
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex justify-between items-center mb-12">
            ...
            {/* orange link */}
            <Link to="/news" className="flex items-center gap-1 text-orange-600 font-semibold hover:text-orange-700 hover:gap-2 transition-all">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-all">
                  <div className="relative overflow-hidden bg-gray-200 dark:bg-gray-700" style={{ height: 192 }}>
                    ...
                    <div className="absolute top-4 left-4">
                      <span className="px-3 py-1 bg-orange-600 text-white rounded-full text-xs font-semibold">{n.category}</span>
                    </div>
                  </div>
                  <div className="p-6">
                    {/* orange hover on title */}
                    <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2 group-hover:text-orange-600 transition-colors">{n.title}</h3>
            ...
            {TESTIMONIALS.map((t, i) => (
              <motion.div key={i} initial={{ opacity:0, scale:0.9 }} whileInView={{ opacity:1, scale:1 }} transition={{ delay: i * 0.1 }} whileHover={{ y:-5 }} className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 border border-gray-100 dark:border-gray-700">
                ...
                <div className="flex mb-3">
                  {[...Array(t.rating)].map((_, j) => (<StarIcon key={j} className="w-5 h-5 text-amber-400 fill-current" />))}
                </div>
      ...
      <section className="py-24 relative overflow-hidden">
        <div className="absolute inset-0">
          ...
          {/* orange gradient overlay (was blue) */}
          <div className="absolute inset-0 bg-gradient-to-r from-orange-600/94 to-orange-800/94" />
        </div>
        <div className="relative z-10 container mx-auto px-4 text-center">
          <motion.div initial={{ opacity:0, y:20 }} whileInView={{ opacity:1, y:0 }} className="max-w-3xl mx-auto">
            ...
            <Link to="/register" className="inline-flex items-center px-8 py-4 bg-white text-orange-600 rounded-xl font-bold text-lg hover:shadow-2xl hover:bg-orange-50 transform hover:scale-105 transition-all">
      ...
      <motion.button
        ...
        className="fixed bottom-8 right-8 z-50 bg-orange-600 text-white p-4 rounded-full shadow-2xl hover:bg-orange-700 transition-all"
      >
